...
class GaussianDiffusion:
    ...
    def __init__(
        self,
        n_timesteps: int,
        scheduler: Literal["linear", "cosinus"] = "linear",
        posterior: Literal["ddpm", "ddim"] = "ddpm",
        model_mean_type: Literal["previous_x", "start_x", "epsilon"] = "epsilon",
        model_var_type: Literal[
            "learned", "fixed_large", "fixed_small", "learned_range"
        ] = "fixed_small",
